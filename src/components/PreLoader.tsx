        ...
        <div className="fixed inset-0 z-[9999] bg-black flex flex-col items-center justify-center overscroll-none touch-none transition-opacity duration-500">
            ...
            <div className="relative flex flex-col items-center">
                ...
                <div className="absolute -top-6 right-0 w-full h-8 overflow-hidden z-0 opacity-60">
                    <div className="absolute top-2 right-[-20px] w-12 h-[2px] bg-red-200 rounded animate-wind-fast"></div>
                    <div className="absolute top-5 right-[-40px] w-20 h-[2px] bg-red-300 rounded animate-wind-medium"></div>
                </div>
                ...
                <div className="relative z-10 animate-rumble">
                    ...
                    >
                        ...
                        <g className="origin-[75px_35px] animate-spin-wheels">
                            <circle cx="75" cy="35" r="7" fill="black" stroke="#f63b3b" strokeWidth="2.5" />
                            <circle cx="75" cy="35" r="2" fill="#f63b3b" />
                            <rect x="74" y="28" width="2" height="14" fill="#f63b3b" rx="1" />
                            <rect x="68" y="34" width="14" height="2" fill="#f63b3b" rx="1" />
                        </g>
                    </svg>
                </div>

                {/* THE MOVING ROAD */}
                <div className="w-48 h-1 bg-red-200 mt-[-2px] rounded-full overflow-hidden relative">
                    <div className="absolute top-0 left-0 h-full w-full bg-[linear-gradient(90deg,transparent_50%,#f63b3b_50%)] bg-[length:20px_100%] animate-road-move"></div>
                </div>

            </div>

            {/* Text */}
            <h2 className="mt-6 text-[#f63b3b] font-bold text-lg tracking-tight uppercase animate-pulse orb">
                ELITE MOTOR CARS
            </h2>
