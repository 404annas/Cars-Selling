                ...
                <div className="fixed inset-0 z-[10001] flex items-center justify-center px-4">
                    ...
                    <div className="bg-white rounded-3xl p-8 shadow-2xl z-20 max-w-sm w-full text-center animate-in zoom-in duration-300">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed">
                            Our team will review your enquiry and get back to you within <span className="font-bold text-[#f23410]">24 to 48 hours</span>.
                        </p>
            ...
            {showModal && (
                <div className="fixed inset-0 z-[10000] flex items-center justify-center px-4">
                    ...
                    <div className="bg-black border-2 border-orange-900 rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-xl relative z-10 animate-in fade-in zoom-in duration-300 max-h-[90vh] overflow-y-auto custom-scrollbar">
                        ...
                        <button onClick={() => setShowModal(false)} className="absolute top-4 right-4 z-20 bg-orange-100 hover:bg-orange-100 text-gray-500 hover:text-[#f23410] p-2 rounded-full transition-colors cursor-pointer">
                            <RiCloseLine size={24} />
                        </button>
                        ...
                        <div className="p-6 sm:p-8 pt-12">
                            ...
                            <div className="grid grid-cols-4 gap-2 sm:gap-3 mb-6 sm:mb-8">
                                {tabs.map((tab) => (
                                    <button key={tab.id} onClick={() => setActiveTab(tab.id)} className={`w-full h-16 sm:h-20 rounded-xl border-4 flex flex-col items-center justify-center transition-all duration-300 cursor-pointer ${activeTab === tab.id ? "border-[#f23410] bg-white shadow-lg translate-y-[-2px]" : "border-gray-200 bg-gray-100 text-gray-500 hover:bg-gray-50"}`}>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="text-xs font-bold text-[#f23410] uppercase">Brand / Make</label>
                                        <select name="make" value={formData.make} onChange={handleChange} className="w-full mt-1 border border-orange-300 rounded-lg p-3 text-sm outline-none focus:border-[#f23410] bg-white cursor-pointer">
                                    ...
                                    <div>
                                        <label className="text-xs font-bold text-[#f23410] uppercase">Model</label>
                                        <input name="model" value={formData.model} onChange={handleChange} type="text" placeholder="e.g. Corolla" className="w-full mt-1 border border-orange-300 rounded-lg p-3 text-sm outline-none focus:border-[#f23410] bg-white" />
                                    </div>
                                </div>

                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="text-xs font-bold text-[#f23410] uppercase">Budget Range</label>
                                        <select name="budget" value={formData.budget} onChange={handleChange} className="w-full mt-1 border border-orange-300 rounded-lg p-3 text-sm outline-none focus:border-[#f23410] bg-white cursor-pointer">
                                    ...
                                    <div>
                                        <label className="text-xs font-bold text-[#f23410] uppercase">Year</label>
                                        <select name="year" value={formData.year} onChange={handleChange} className="w-full mt-1 border border-orange-300 rounded-lg p-3 text-sm outline-none focus:border-[#f23410] bg-white cursor-pointer">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="text-xs font-bold text-[#f23410] uppercase">Email</label>
                                        <input name="email" value={formData.email} onChange={handleChange} type="email" placeholder="email@example.com" className="w-full mt-1 border border-orange-300 rounded-lg p-3 text-sm outline-none focus:border-[#f23410] bg-white" />
                                    </div>
                                    <div>
                                        <label className="text-xs font-bold text-[#f23410] uppercase">Phone Number</label>
                                        <input name="phone" value={formData.phone} onChange={handleChange} type="tel" placeholder="+61 (555) 000-0000" className="w-full mt-1 border border-orange-300 rounded-lg p-3 text-sm outline-none focus:border-[#f23410] bg-white" />
                                    </div>
                                </div>

                                <button onClick={handleSubmit} className="w-full bg-[#f23410] hover:bg-[#d92c0d] text-white font-bold py-4 rounded-lg uppercase cursor-pointer transition-all duration-300 mt-2 text-xs sm:text-sm shadow-sm active:scale-95 flex items-center justify-center gap-2">
                                    Submit Enquiry
                                </button>
                            </div>
                        </div>
