    ...
    <section className="w-full py-10 bg-black overflow-hidden">
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-10 relative">
          {/* Background Line */}
          <div className="absolute left-0 right-0 top-1/2 h-[1px] bg-[#f23410]/30 -z-10 hidden md:block"></div>
          ...
          <div className="bg-[#fbebeb] pr-6 z-10 mx-auto md:mx-0">
            ...
            <div className="absolute left-0 right-0 top-1/2 -translate-y-1/2 text-center pointer-events-none hidden md:block">
              <span className="bg-black px-6 text-2xl sm:text-3xl font-bold text-[#f23410]">
                User Reviews & Ratings
              </span>
            </div>
            {/* Mobile Title */}
            <h2 className="text-2xl sm:text-3xl font-bold text-[#f23410] md:hidden text-center">
              User Reviews & Ratings
            </h2>
          </div>
          ...
          <div className="bg-black pl-6 z-10 hidden md:flex items-center gap-4">
            <button
              ...
              className={`p-2 rounded-full transition-colors cursor-pointer duration-300 ${currentIndex === 0 ? 'text-[#f23410]/50 bg-[#f23410]/10 hover:cursor-not-allowed' : 'text-[#f23410] hover:bg-[#f23410]/10'}`}
            >
            ...
            <button
              ...
              className={`p-2 rounded-full transition-colors cursor-pointer duration-300 ${currentIndex >= maxIndex ? 'text-[#f23410]/50 bg-[#f23410]/10 hover:cursor-not-allowed' : 'text-[#f23410] hover:bg-[#f23410]/10'}`}
            >
        ...
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="shrink-0 w-full lg:w-[280px]">
            <div className="bg-[#fdd1d1] rounded-xl p-8 flex flex-col items-center justify-center h-full min-h-[200px]">
              <span className="text-[#f23410] text-6xl font-bold mb-2">4.9</span>
          ...
          <div className="flex-1 overflow-hidden relative">
            ...
            >
              {reviews.map((review) => (
                ...
                >
                  <div className="border border-[#f23410]/30 rounded-xl p-6 h-[250px] flex flex-col justify-between bg-black">

                    {/* Card Top: Name & Stars */}
                    <div>
                      <div className="flex justify-between items-center mb-1">
                        <h3 className="text-[#f23410] font-medium text-lg truncate pr-2">
                          {review.name}
                        </h3>
                    ...
                    <button className="text-gray-400 text-sm underline self-start hover:text-[#f23410] cursor-pointer transition-all duration-300 mt-2">
                      Read more
                    </button>
                  </div>
                </div>
