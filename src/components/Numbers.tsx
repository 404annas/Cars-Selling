        ...
        <section className="pt-10 pb-20 bg-black">
            <div className="container mx-auto px-6">
              ...
              `}
                    ...
                    ${stat.theme === "blue"
                                            ? "bg-orange-400" // Lighter blue shape on blue Card
                                            : "bg-orange-500/10" // Faint blue shape on Dark Card
                                        }
                  `}
                                    style={{
                    ...
                    ${stat.theme === "blue"
                                            ? "bg-orange-600" // Darker blue shape on blue Card
                                            : "bg-orange-900/20" // Dark blue shape on Dark Card
                                        }
                  `}
                                    style={{
                    ...
                    ${stat.theme === "blue"
                                            ? "border-orange-800" // Dark blue line on blue card
                                            : "border-orange-500" // Bright blue line on Dark card
                                        }
                  `}
                                >
                                    {/* Icon */}
                                    <div
                                        className={`mb-2
                      ${stat.theme === "blue"
                                                ? "text-orange-800" // Dark Icon on blue
                                                : "text-orange-500" // blue Icon on Dark
                                            }
                    `}
                                    >
                                        {stat.icon}
                      ...
                      ${stat.theme === "blue"
                                                ? "text-orange-900" // Dark Text on blue
                                                : "text-orange-500" // blue Text on Dark
                                            }
                    `}
                                    >
                                        {stat.label}
